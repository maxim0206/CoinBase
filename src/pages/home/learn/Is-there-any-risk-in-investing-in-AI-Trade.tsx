...
import Aitradelearn from "@/assets/images/Is-there-any-risk-in-investing-in-AI-Trade.svg";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export default () => {
  ...
  const { lang } = useMyIntl("Allinvestmentprojectsintheworldarerisky");
  return (
        ...
        <Flex w="full" flexDir="column">
          ...
          <Wrap py={6} spacing="24px" flexWrap="wrap">
            <WrapItem flexDir="column" flex="1">
              ...
              <Text fontWeight="var(--cds-fontWeights-medium)" pt={12} pb={4} fontSize="2rem" id="Fund-pool-guarantee">
                {lang[4]}
              </Text>
              <Text fontSize="1.2rem" lineHeight="2rem"  pt={6} >
                {lang[5]}
              </Text>
              <Text fontWeight="var(--cds-fontWeights-medium)" pt={12} pb={4} fontSize="2rem" id="Seven-days-delay-in-liquidation">
                {lang[6]}
              </Text>
              <Text fontSize="1.2rem" lineHeight="2rem"  pt={6} >
                {lang[7]}
              </Text>
              <Text fontWeight="var(--cds-fontWeights-medium)" pt={12} pb={4} fontSize="2rem" id="Prevent-liquidation">
                {lang[8]}
              </Text>
              <Text fontSize="1.2rem" lineHeight="2rem"  pt={6} >
                {lang[9]}
              ...
              <Flex sx={getFixed} py="0.8rem" px="1.2rem">
                <List>
                  <ListItem fontSize="1rem" color="#5b616e" lineHeight="1.8rem" pb={2}>
                    <Link href="#Fund-pool-guarantee">
                      {lang[11]}
                    </Link>
                  </ListItem>
                  <ListItem fontSize="1rem" color="#5b616e" lineHeight="1.8rem" pb={2}>
                    <Link href="#Seven-days-delay-in-liquidation">
                      {lang[12]}
                    </Link>
                  </ListItem>
                  <ListItem fontSize="1rem" color="#5b616e" lineHeight="1.8rem" pb={2}>
                    <Link href="#Prevent-liquidation">
                      {lang[13]}
                    </Link>
                  </ListItem>
                </List>
