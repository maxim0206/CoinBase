...
import Aitradelearn from "@/assets/images/Why-is-the-digital-currency-invested-by-AI-Trade-for-me-all-growing-positively-and-there-will-still-be-losses.svg";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export default () => {
  ...
  const { lang } = useMyIntl("LearningmoreaboutAiTrade");
  return (
        ...
        <Flex w="full" flexDir="column">
          ...
          <Wrap py={6} spacing="24px" flexWrap="wrap">
            <WrapItem flexDir="column" flex="1">
              ...
              <Text fontWeight="var(--cds-fontWeights-medium)" pt={12} pb={4} fontSize="2rem" id="The-investment-process-of-AI-Trade">
                {lang[4]}
              </Text>
              <Text fontSize="1.2rem" lineHeight="2rem"  pt={6} >
                {lang[5]}
              ...
              <Text fontSize="1.2rem" lineHeight="2rem"  pt={6} ><Text as="b">
                {lang[7]}
              </Text>
                {lang[8]}
              </Text>
              ...
              <Flex sx={getFixed} py="0.8rem" px="1.2rem">
                <List>
                  <ListItem fontSize="1rem" color="#5b616e" lineHeight="1.8rem" pb={2}>
                    <Link href="#The-investment-process-of-AI-Trade">
                      {lang[13]}
                    </Link>
                  </ListItem>
                </List>
